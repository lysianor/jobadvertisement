      ...
      <div class="row align-items-end">
        ...
        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
          <ul class="socials socials--round socials--colored">
            ...
            <button type="button" class="crumina-button button--red button--l">Pending</button>
            @else
            <button type="button" class="crumina-button button--blue-dark button--l">Approved</button>
            @endif
          </ul>
        </div>
      </div>
