                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="form-button-action">
                                                    <a data-toggle="tooltip" href="{{ route('employer.post.show',[$post->id, $post->slug]) }}" class="btn btn-link btn-primary btn-lg" data-original-title="View">
                                                        <i class="fa fa-eye"></i>
                                                    </a>
                                                    <a data-toggle="tooltip" href="{{ route('employer.post.edit',$post->id) }}" title="" class="btn btn-link btn-primary btn-lg" data-original-title="Edit">
                                                    ...
                                                    <form id="delete-form-{{ $post->id }}" action="{{ route('employer.post.destroy',$post->id) }}" method="POST" style="display: none;">
                                                    @csrf
                                                    @method('DELETE')
                                                    </form>
                                                </div>
