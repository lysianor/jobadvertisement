    ...
    <div class="container">
        <div class="page-inner">
            <div class="page-header">
                <h4 class="page-title">Pending Job Post</h4>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex align-items-center">
                                <h4 class="card-title">Pending Job Post</h4>
                            </div>
                        </div>
                        <div class="card-body">
                            <!-- Modal -->
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="form-button-action">
                                                    ...
                                                    <a data-toggle="tooltip" title="" class="btn btn-link btn-secondary btn-lg" data-original-title="Approve" onclick="approvePost({{ $post->id }})">
