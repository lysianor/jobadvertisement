      ...
      <div class="row">
        <div class="col-xl-12">
          ...
          <div class="row">
              ...
              <div class="fj_post home3 bbt">
                <div class="details">
                  <div class="thumb fn-smd">
                    <img class="img-fluid" src="/profile/{{$post->user->image}}" alt="{{ $post->title }}">
                  </div>
                  ...
                  <ul class="featurej_post">
                    ...
                    <li class="list-inline-item"><span class="flaticon-money pl20"></span> {{ ucwords($post->salary) }} {{ ucwords($post->per) }}</li>
            ...
            @else
            <div class="col-sm-6 col-lg-12">
                <h1>There are no categories matching for your search criteria.</h1>
